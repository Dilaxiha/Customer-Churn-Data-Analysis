...
Trains a Random Forest on cleaned data with a Train / Validation / Test split (70/15/15),
evaluates performance across all three sets, and saves evaluation metrics, plots,
and models inside a dedicated 'random_forest' output subfolder.
"""
...
with redirect_stdout(results_buffer):
    ...
    print(f"\nAll outputs successfully saved to: {RF_OUTPUT_DIR}")
